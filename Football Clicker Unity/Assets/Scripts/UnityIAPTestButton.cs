...
namespace Assets.Scripts
{
    ...
    public class UnityIAPTestButton : MonoBehaviour
    {
        ...
        void MakePurchase()
        {
            ...
            AnalyticsEvent.IAPTransaction("Tickets-Green-3", storeItemPrice, storeItemId);
            AnalyticsEvent.ItemAcquired(AcquisitionType.Premium, "Tickets-Green-3", storeItemPrice, storeItemId);
